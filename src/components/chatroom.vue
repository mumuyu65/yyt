        ...
        <ol class="list-inline">
            <li style="width:75%;">
                ...
                <ul class="list-inline">
                    ...
                    <li class="chat-icon"><span>高级</span></li>
                    <li class="chat-icon"><span>开户</span></li>
                    <li class="chat-icon"><span>升级权限</span></li>
                </ul>
            ...
            <li style="position:absolute;top:0;right:0; height:100%; width:24.5%; border:1px solid #4b4b4b;" class="text-center">
                <h4 style="padding:20px 0;">直播大厅</h4>
                <h4 style="padding:20px 0;">商城战队</h4>
                <h4 style="padding:20px 0;">北城战队</h4>
                <h4 style="padding:20px 0;">大户一对一</h4>
            </li>
        </ol>
    </div>
</template>
